...
def numpy_mask_to_coco_polygon(numpy_mask):
    contours, _ = cv2.findContours(
        numpy_mask.astype(np.uint8), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE
    )
...
coco_dataset = {
    ...
    "categories": [
        ...
        {"id": 20, "name": "20", "supercategory": ""},
        {"id": 21, "name": "21", "supercategory": ""},
        {"id": 22, "name": "22", "supercategory": ""},
        {"id": 23, "name": "23", "supercategory": ""},
        {"id": 24, "name": "24", "supercategory": ""},
    ],
}
