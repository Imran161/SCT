...
#                 suffix += f"{category_name}<loc_{box[0]
#                                                  }><loc_{box[1]}><loc_{box[2]}><loc_{box[3]}>"
#
#             jsonl_data.append(
#                 {
...
# тут пишет что запросов слишком много
...
# with tqdm(
#     total=len(os.listdir(source_dir)), desc="Processing directories"
# ) as pbar_dirs:
...
# print("Все архивы успешно распакованы и файлы instances_default.json обновлены.")
