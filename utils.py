...
class ImageVisualizer:
    ...
    #             # надо сделать контуры не на черном фоне а на картинке
    #             contours_image = np.zeros((image.shape[0], image.shape[1], 3), dtype=np.uint8)
    ...
    #                     cv2.drawContours(contours_image, [contour], -1, (255, 0, 0), 2)
    ...
    #                     cv2.putText(contours_image, text, (text_x, text_y), cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1, cv2.LINE_AA)
